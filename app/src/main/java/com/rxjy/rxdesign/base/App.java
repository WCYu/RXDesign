    ...
    private void appGoOnLine() {
        registerActivityLifecycleCallbacks(new ActivityLifecycleCallbacks() {
            ...
            public void onActivityStopped(Activity activity) {
                Log.e("tag_App", activity + "onActivityStopped");
                count--;
            ...
            public void onActivityStarted(Activity activity) {
                Log.e("tag_App", activity + "onActivityStarted");
                String cardNo = MySharedPreferences.getInstance().getCardNo();
                if (count == 0) {
                    if (TextUtils.isEmpty(cardNo)) {
            ...
            public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
                Log.e("tag_App", activity + "onActivitySaveInstanceState");
            }

            @Override
            public void onActivityResumed(Activity activity) {
                Log.e("tag_App", activity + "onActivityResumed");
            }

            @Override
            public void onActivityPaused(Activity activity) {
                Log.e("tag_App", activity + "onActivityPaused");
            }

            @Override
            public void onActivityDestroyed(Activity activity) {
                Log.e("tag_App", activity + "onActivityDestroyed");
            }

            @Override
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                Log.e("tag_App", activity + "onActivityCreated");
            }
        });
    }
