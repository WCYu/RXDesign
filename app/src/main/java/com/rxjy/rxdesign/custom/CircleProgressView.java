package com.rxjy.rxdesign.custom;
...
public class CircleProgressView extends View {
    ...
    private int circlebgcolor = 0;//自定义背景的颜色
    private int circlecolor = 0;//自定义圆圈的颜色

    private int mCircleLineStrokeWidth = 8;//圆弧的宽度
    ...
    public void setProgress(int progress, int circlebgcolor, int circlecolor, String strContent, int mCircleLineStrokeWidth) {
        this.mProgress = progress;
