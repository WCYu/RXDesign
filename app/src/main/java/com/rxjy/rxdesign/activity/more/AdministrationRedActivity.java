...
public class AdministrationRedActivity extends BaseActivity {
    ...
    private void getRedTask(String cardNo) {
        ...
        OkhttpUtils.doGet(this, PathUrl.WTSREDLISTURL, map, new OkhttpUtils.MyCall() {
            @Override
