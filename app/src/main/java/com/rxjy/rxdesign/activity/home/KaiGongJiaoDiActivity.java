...
* 开工交底
* */
public class KaiGongJiaoDiActivity extends BaseActivity {
    ...
    public int getLayout() {
        return R.layout.activity_kai_gong_jiao_di;
    }
    ...
    protected void onResume() {
        super.onResume();
        getUCAllImages(bodyBean.getCi_RwdId(), 1);
    }
