...
public class NewLiangFangBean {
    ...
    public static class BodyBean {
        ...
        private ImagesArrayBean ImagesArray;
        ...
        public ImagesArrayBean getImagesArray() {
            return ImagesArray;
        }

        public void setImagesArray(ImagesArrayBean ImagesArray) {
            this.ImagesArray = ImagesArray;
        }

        public static class ImagesArrayBean {
            private List<LFImagesBean> LFImages;
            private List<QYImagesBean> QYImages;

            public List<LFImagesBean> getLFImages() {
                return LFImages;
            }

            public void setLFImages(List<LFImagesBean> LFImages) {
                this.LFImages = LFImages;
            }

            public List<QYImagesBean> getQYImages() {
                return QYImages;
            }

            public void setQYImages(List<QYImagesBean> QYImages) {
                this.QYImages = QYImages;
            }

            public static class LFImagesBean {
                ...
                public static class ChildListBean {
                    /**
                     * DetailID : 414164
                     * ImageUrl : Image/2018/02/01/09281747422926.jpg
                     */
            ...
            public static class QYImagesBean {
